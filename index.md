...
# NetPort Configurator {#netport-configurator}
...
2. **Permisos elevados.**
    ...
    - Revisar el manual de usuario que brinda NetPort: [Manual de Usuario](https://github.com/Masu-113/NetPort-Configurator/blob/main/documentacion/ManualDeUsuario-NetPort_v1.0.pdf).
...
## Changelog {#changelog}
**Para ver las versiones y cambios, consulta el archivo [changelog.md](https://github.com/Masu-113/NetPort-Configurator/blob/main/CHANGELOG.md).**
